(function (global, factory) {
  ...
  var piClass = "js-".concat(vl.ns, "pill-input"),
      piPillInputClass = "".concat(vl.ns, "pill-input"),
      piPillContainerInnerClass = "".concat(piPillInputClass, "__inner"),
      piPillListClass = "".concat(vl.ns, "pill-input__list"),
      piPillListMultipleClass = "".concat(piPillListClass, "--multiple"),
      piPillClass = "".concat(vl.ns, "pill"),
      piPillClickableClass = "".concat(piPillClass, "--clickable"),
      piPillCloseClass = "".concat(piPillClass, "__close"),
      piPillNoticeClass = "".concat(vl.ns, "form__annotation"),
      piPillAtt = "data-".concat(vl.ns, "pill-input"),
      piPillDressedAtt = "".concat(piPillAtt, "-dressed"),
      piPillEmailAtt = "".concat(piPillAtt, "-email"),
      piPillUniqueAtt = "".concat(piPillAtt, "-unique"),
      piPillInputfieldClass = "".concat(piPillClass, "__input");
  /**
   * Private Functions
   */

  var _prepareChoisesConfig = function _prepareChoisesConfig(element) {
    var config = {}; // If input should be unique
  ...
  function () {
    function PillInput() {
      ...
      this.globalConfig = {
        ...
        uniqueItemText: function uniqueItemText(value) {
          return "Item \"".concat(value, "\" werd al toegevoegd");
        },
        addItemText: function addItemText(value) {
          return "Druk Enter om <b>\"".concat(value, "\"</b> toe te voegen");
        },
        maxItemText: function maxItemText(maxItemCount) {
          return "Er kunnen maar ".concat(maxItemCount, " items worden toegevoegd.");
        },
    ...
    _createClass(PillInput, [{
      ...
      value: function dress(element) {
        var config = {};
        element.setAttribute(piPillDressedAtt, true); // Build select config
      ...
      value: function dressAll() {
        ...
        // get all elements
        var elements = document.querySelectorAll(".".concat(piClass, ":not([").concat(piPillDressedAtt, "]):not([data-").concat(vl.ns, "js-dress=\"false\"]),\n      [").concat(piPillAtt, "]:not([").concat(piPillDressedAtt, "]):not([data-").concat(vl.ns, "js-dress=\"false\"])")); // add functionality to the element
